...
public class NavigationDrawerFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0; i < ShowResult.department.size(); i++){
            ...
            m.put("groupName", ShowResult.department.get(i));
        ...
        exList = (ExpandableListView) inflater.inflate(
        ...
        exList.setAdapter(new SimpleExpandableListAdapter(getActivity(),
                groupData,
                ...
                childFrom,
                childTo));
        exList.setItemChecked(mCurrentSelectedPosition, true);
        return exList;
    }
    ...
    private void selectItem(int position) {
        ...
        if (exList != null) {
            exList.setItemChecked(position, true);
        }
